-- Fix Users Table RLS Policies - Phase 1 Critical Security Fix (Enum Fixed - Safe Version)
...
-- Create a function to get user info based on role (Fixed for enum)
...
-- Create a function to list users based on role (Fixed for enum)
