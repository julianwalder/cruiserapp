...
# Aggressive Scripts Cleanup - Keep only truly essential scripts
# This removes 95% of the scripts folder, keeping only what's actually needed

echo "🧹 Starting AGGRESSIVE scripts cleanup..."
echo "⚠️  This will remove 95% of the scripts folder!"

# Essential scripts to KEEP (only these will remain)
ESSENTIAL_SCRIPTS=(
    # Recent and useful
    ...
    # Core database schemas (keep the most recent/complete ones)
...
TEMP_DELETE_LIST="/tmp/scripts_to_delete_aggressive.txt"
> "$TEMP_DELETE_LIST"
...
echo ""
echo "⚠️  AGGRESSIVE CLEANUP: This will delete $FILES_TO_DELETE files from the scripts directory."
echo "✅ Only $ESSENTIAL_COUNT essential files will be preserved."
echo "🚨 This is a major cleanup - 95% of files will be removed!"
echo ""
...
echo "🧹 Aggressive scripts cleanup finished."
