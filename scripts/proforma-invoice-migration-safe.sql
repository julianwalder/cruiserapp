-- =====================================================
-- PROFORMA INVOICE SYSTEM - SAFE MIGRATION SCRIPT
-- =====================================================
...
-- =====================================================
-- 2. ADD NEW COLUMN TO INVOICE_CLIENTS TABLE
-- =====================================================

-- Add company_id column to invoice_clients table
...
-- =====================================================
-- 5. DROP EXISTING TRIGGERS AND FUNCTIONS (IF THEY EXIST)
-- =====================================================
...
-- =====================================================
-- 6. CREATE FUNCTION TO UPDATE PAYMENT STATUS
-- =====================================================
...
-- =====================================================
-- 7. CREATE TRIGGER FOR AUTOMATIC UPDATES
-- =====================================================
...
DROP VIEW IF EXISTS proforma_invoices_view;
DROP VIEW IF EXISTS fiscal_invoices_view;

-- =====================================================
-- 9. CREATE VIEW FOR PROFORMA INVOICES
-- =====================================================
...
-- =====================================================
-- 10. CREATE VIEW FOR FISCAL INVOICES
-- =====================================================
...
-- =====================================================
-- 12. ADD ROW LEVEL SECURITY POLICIES
-- =====================================================
...
-- You can verify the migration worked by running this query:
