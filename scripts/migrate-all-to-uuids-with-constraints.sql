-- Comprehensive UUID Migration Script with Constraint Handling
...
-- Step 4: Drop existing foreign key constraints and policies
-- Drop foreign key constraints that reference users.id
ALTER TABLE users DROP CONSTRAINT IF EXISTS users_createdById_fkey;
ALTER TABLE sessions DROP CONSTRAINT IF EXISTS sessions_userId_fkey;
ALTER TABLE airfields DROP CONSTRAINT IF EXISTS airfields_createdById_fkey;
ALTER TABLE operational_areas DROP CONSTRAINT IF EXISTS operational_areas_createdById_fkey;
...
ALTER TABLE base_management DROP CONSTRAINT IF EXISTS base_management_baseManagerId_fkey;
ALTER TABLE fleet_management DROP CONSTRAINT IF EXISTS fleet_management_assignedPilotId_fkey;
ALTER TABLE flight_logs DROP CONSTRAINT IF EXISTS flight_logs_pilotId_fkey;
ALTER TABLE flight_logs DROP CONSTRAINT IF EXISTS flight_logs_instructorId_fkey;
ALTER TABLE flight_logs DROP CONSTRAINT IF EXISTS flight_logs_createdById_fkey;
ALTER TABLE password_reset_tokens DROP CONSTRAINT IF EXISTS password_reset_tokens_user_id_fkey;
ALTER TABLE invoice_clients DROP CONSTRAINT IF EXISTS invoice_clients_user_id_fkey;
ALTER TABLE flight_hours DROP CONSTRAINT IF EXISTS flight_hours_user_id_fkey;
ALTER TABLE user_company_relationships DROP CONSTRAINT IF EXISTS user_company_relationships_user_id_fkey;
ALTER TABLE ppl_course_tranches DROP CONSTRAINT IF EXISTS ppl_course_tranches_user_id_fkey;

-- Drop foreign key constraints that reference other tables
...
ALTER TABLE flight_logs DROP CONSTRAINT IF EXISTS flight_logs_departureAirfieldId_fkey;
ALTER TABLE flight_logs DROP CONSTRAINT IF EXISTS flight_logs_arrivalAirfieldId_fkey;
ALTER TABLE base_management DROP CONSTRAINT IF EXISTS base_management_airfieldId_fkey;
...
-- Aircraft table
ALTER TABLE aircraft DROP COLUMN IF EXISTS id;
...
-- Flight_logs table
ALTER TABLE flight_logs DROP COLUMN IF EXISTS id;
ALTER TABLE flight_logs DROP COLUMN IF EXISTS "aircraftId";
ALTER TABLE flight_logs DROP COLUMN IF EXISTS "pilotId";
ALTER TABLE flight_logs DROP COLUMN IF EXISTS "instructorId";
ALTER TABLE flight_logs DROP COLUMN IF EXISTS "departureAirfieldId";
ALTER TABLE flight_logs DROP COLUMN IF EXISTS "arrivalAirfieldId";
ALTER TABLE flight_logs DROP COLUMN IF EXISTS "createdById";
...
-- Airfields table
ALTER TABLE airfields DROP COLUMN IF EXISTS id;
...
ALTER TABLE base_management DROP COLUMN IF EXISTS id;
ALTER TABLE base_management DROP COLUMN IF EXISTS "airfieldId";
ALTER TABLE base_management DROP COLUMN IF EXISTS "baseManagerId";
...
-- Step 8: Update any remaining foreign key references in other tables
...
FROM users 
WHERE user_company_relationships.user_id = users.id;

ALTER TABLE user_company_relationships DROP COLUMN IF EXISTS user_id;
...
SET user_id_uuid = users.id 
FROM users 
WHERE invoice_clients.user_id = users.id;

ALTER TABLE invoice_clients DROP COLUMN IF EXISTS user_id;
...
SET user_id_uuid = users.id 
FROM users 
WHERE flight_hours.user_id = users.id;

ALTER TABLE flight_hours DROP COLUMN IF EXISTS user_id;
...
SET user_id_uuid = users.id 
FROM users 
WHERE ppl_course_tranches.user_id = users.id;

ALTER TABLE ppl_course_tranches DROP COLUMN IF EXISTS user_id;
...
-- Step 9: Add foreign key constraints for updated tables
ALTER TABLE user_company_relationships 
...
-- Step 10: Create indexes for the updated foreign keys
