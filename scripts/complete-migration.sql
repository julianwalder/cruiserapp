...
-- This script completes the migration by dropping old columns and renaming UUID columns
...
-- Step 4: Update any remaining foreign key references in other tables
...
-- Step 5: Add foreign key constraints for updated tables
ALTER TABLE user_company_relationships 
...
-- Step 6: Create indexes for the updated foreign keys
