    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Account for announcement bar height when positioning modals
          "top-[calc(50%+var(--announcement-height,0px)/2)] translate-y-[-50%]",
          className
        )}
        {...props}
      >
